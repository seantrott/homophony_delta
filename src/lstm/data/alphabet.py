"""Adapted from Pimentel et al (2021).

Original code: https://github.com/rycolab/homophony-as-renyi-entropy
"""
...
class Alphabet:
    ...
    def idx2word(self, idx_word):
        self._update_idx2char()
        return [
            self._idx2chars[idx]
            for idx in idx_word
            if idx not in {self.PAD_IDX, self.EOS_IDX}
        ]
